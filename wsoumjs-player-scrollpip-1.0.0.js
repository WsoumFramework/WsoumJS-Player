/*!
 * WsoumPlayer ScrollPIP JavaScript Library v1.0.0
 * https://framework.wsoum.ml/wsoumplayer-scrollpip/
 *
 * Redistribution Plyr
 * https://plyr.io/
 *
 * Copyright (c) Wsoum and Sam Potts 2017
 * Released under the MIT license
 * https://framework.wsoum.ml/wsoumplayer-scrollpip/license
 *
  ...
  function C(v, C) {
    ...
    function Ve() {
      if (g(Ye.media, "timeupdate seeking", Ne), g(Ye.media, "timeupdate", W), g(Ye.media, "durationchange loadedmetadata", Ie), g(Ye.media, "ended", function() {
        ...
        if (!e) return;
        e.style.cursor = "", g(e, "click", function() {
...
*/
  ...
  var VideoAudioHandler = function() {
    ...
    plyr.setup(document.querySelectorAll("video:not(.vided)"), {
      enabled: true
    });
    ...
    $(window).scroll(function() {
    	 ...
    	 else
    	 {
	      ...
	      $("video:not(.vided)").addClass("vided");
  };
